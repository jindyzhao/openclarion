...
type Tenant struct {
	...
	// stable lowercase tenant key used in authenticated selection
	Key string `json:"key,omitempty"`
	// operator-facing tenant name
	Name string `json:"name,omitempty"`
	// active or disabled; disabled tenants cannot issue new sessions
...
func (*Tenant) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case tenant.FieldKey, tenant.FieldName, tenant.FieldStatus:

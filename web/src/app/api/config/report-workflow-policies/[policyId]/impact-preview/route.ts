import { previewReportWorkflowPolicyImpact } from "@/features/settings/report-workflow-policies/api";
...
export async function POST(_request: Request, context: RouteContext) {
  ...
  return apiResultResponse(await previewReportWorkflowPolicyImpact(parsedID.data));
}

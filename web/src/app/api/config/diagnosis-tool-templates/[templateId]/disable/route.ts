import { disableDiagnosisToolTemplate } from "@/features/settings/diagnosis-tool-templates/api";
...
export async function POST(_request: Request, context: RouteContext) {
  ...
  return apiResultResponse(await disableDiagnosisToolTemplate(parsedID.data));
}

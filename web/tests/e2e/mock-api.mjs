...
function reportWorkflowScheduleFromBody(
  ...
  return {
    ...
    cadence: String(body.cadence ?? "interval"),
    calendar_hour: Number.parseInt(String(body.calendar_hour ?? "0"), 10),
    calendar_minute: Number.parseInt(String(body.calendar_minute ?? "0"), 10),
    calendar_day_of_week: Number.parseInt(
      String(body.calendar_day_of_week ?? "0"),
      10,
    ),
    calendar_day_of_month: Number.parseInt(
      String(body.calendar_day_of_month ?? "0"),
      10,
    ),

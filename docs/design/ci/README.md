...
| Documentation shipped-claims consistency | W4-3 | landed | `make doc-claims-check`; checks path hints in `docs/design/CURRENT_STATE.md` shipped rows exist on disk and rejects symlink/non-regular `CURRENT_STATE.md` before parsing |

...
| Generated file header validation | M0 -> M1 hardening | landed | `make generated-headers`; validates committed OpenAPI Go, Ent, and frontend OpenAPI TypeScript generated files retain their generator-owned headers / direct-edit warnings and rejects symlink/non-regular generated-file inputs. `go test ./scripts` carries positive, missing-header, and regular-file/no-symlink fixtures for each generated family. |
